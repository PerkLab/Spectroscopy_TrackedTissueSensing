...
class BroadSpecModule(ScriptedLoadableModule):
...
#
# BroadSpecModuleWidget
#

class BroadSpecModuleWidget(ScriptedLoadableModuleWidget):
  ...
  def setup(self):
    ...
    self.logic = BroadSpecModuleLogic()
...
#
# BroadSpecModuleLogic
#

class BroadSpecModuleLogic(ScriptedLoadableModuleLogic):
...
class BroadSpecModuleTest(ScriptedLoadableModuleTest):
  """
  ...
  def runTest(self):
    ...
    """
    self.setUp()
    self.test_BroadSpecModule1()

  def test_BroadSpecModule1(self):
